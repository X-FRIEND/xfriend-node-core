...
const expressContextMiddleware = require('./context-middleware');
const expressLoggingMiddleware = require('./logging-middleware');
 ...
 */
module.exports = function serverAppBuilder(options = {}) {
  const app = express();
