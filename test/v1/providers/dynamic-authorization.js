...
const tokenData = require('../../helpers/authentication-token-data');
const DynamicAuthorizationProvider = require('../../../v1/src/providers/dynamic-authorization');
const { error } = require('../../../v1/src/providers/authorization-enum');
