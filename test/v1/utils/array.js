...
const ArrayUtils = require('../../../v1/src/utils/array');
const helper = require('../../helpers/array-utils-data');
          ...
          return {
            ...
            item: {
              price: newContext !== null && dataset.productItens.length === 0
                ? newContext.promotions.reduce(
                  (acc, promotion) => acc * ((100 - promotion) / 100),
                  dataset.price,
                )
                : dataset.price,
